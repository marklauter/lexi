...
public sealed class Parser(Lexer lexer)
{
        ...
        ref readonly MatchResult matchResult)
    {
        ...
        return matchResult.Symbol.IsComparisonOperator()
            ? ComparisonOperator.FromUInt32(matchResult.Symbol.TokenId)
        ...
        Keywords expectedWord)
    {
        ...
        return matchResult.Symbol.IsKeyword()
            && Keyword.FromUInt32(matchResult.Symbol.TokenId).Value == expectedWord
                ? Keyword.FromUInt32(matchResult.Symbol.TokenId)
        ...
        ref readonly MatchResult matchResult)
    {
        ...
        {
            TokenIds.INTEGER_LITERAL => NumericLiteral.FromInt32(int.Parse(
                matchResult.Source.ReadSymbol(in matchResult.Symbol),
                NumberStyles.Integer,
                CultureInfo.InvariantCulture)),
            TokenIds.FLOATING_POINT_LITERAL => NumericLiteral.FromDouble(double.Parse(
                matchResult.Source.ReadSymbol(in matchResult.Symbol),
