    ...
    : Expression
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator ComparisonOperators(ComparisonOperator value) => value.Value;

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator ComparisonOperator(ComparisonOperators value) => new(value);
}
